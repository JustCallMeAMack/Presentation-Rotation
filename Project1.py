...
if len(most_frequent_presenter) > 1:
    print(f"The people we'll be hearing the most from are {
          most_frequent_presenter}.")
else:
    print(f"The person we'll be hearing the most from is {
          most_frequent_presenter[0]}.")
